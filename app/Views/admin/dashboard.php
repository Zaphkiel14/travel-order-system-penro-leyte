         ...
         <div class="card mb-4">
            ...
            <div class="card-body table-responsive">
               <table id="inventory_table"
                  ...
                  <tbody>
                     <?php if (!empty($travelOrders)):  ?>
                        <?php foreach ($travelOrders as $order): ?>
                           <tr>
                              <td><?= $order['created_at'] ?></td>
                              <td><?= $order['destination'] ?></td>
                              <td><?= $order['departure_date'] ?> to <?= $order['arrival_date'] ?></td>
                              <td>
                                 <?php if ($order['status'] === 'Pending Supervisor'): ?>
                              ...
                              <td>
                                 <button class="btn btn-sm btn-info" data-bs-toggle="modal" data-bs-target="#modal-travel-order-details" data-travel-order-id="<?= $order['travel_order_id'] ?>">
...
<div class="modal fade" id="modal-travel-order-details">
   <div class="modal-dialog modal-lg">
      <div class="modal-content">
         <div class="modal-header">
            <h4 class="modal-title">Travel Order Details</h4>
            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
         </div>
         ...
         <div class="modal-body">
            ...
            <div class="row mb-3">
               <div class="col-6">
                  <p class="mb-1 text-muted">Travel Order Number</p>
                  <h5 class="mb-0"><? $order['travel_order_number'] ?></h5>
               </div>
               <div class="col-6">
                  <p class="mb-1 text-muted">Date Submitted</p>
                  <h5 class="mb-0"><? $order['created_at'] ?></h5>
               </div>
            </div>
