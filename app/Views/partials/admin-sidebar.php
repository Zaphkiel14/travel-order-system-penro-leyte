      ...
      <div class="sidebar-wrapper">
        <nav class="mt-2">
          ...
          <ul
            ...
            <!-- end::Dashboard -->
            <!-- begin::Analytics -->
            <!-- TODO: Update route_to() with the correct route for Analytics page -->
            <li class="nav-item">
              <a href="<?= route_to('view.inventory') ?>" class="nav-link <?= ($page == 'Analytics') ? 'active' : '' ?>">  
            ...
            <!-- begin:: Field Offices -->
            <li class="nav-item">
              <a href="<?= route_to('view.field-offices') ?>" class="nav-link <?= ($page == 'Field Offices') ? 'active' : '' ?>">
            ...
            <li class="nav-item <?= (($parentSidebar ?? '') === 'Inventory') ? 'menu-open' : '' ?>">
              ...
              <ul class="nav nav-treeview">
                ...
                <li class="nav-item">
                  <a href="<?= 'view.Technical-scientific-equipment'?>" class="nav-link">
                ...
                <li class="nav-item">
                  <a href="<?= route_to('view.furniture-fixures-books') ?>" class="nav-link">
                ...
                <li class="nav-item">
                  <a href="<?= route_to('view.transporation-equipment') ?>" class="nav-link">
