...
<head>
  ...
  <style>
    ...
    * { box-sizing: border-box; }
    ...
    .header-text, .footer-text { text-align: center; }

    .header-img-left  img { width: 27mm; height: 27mm; object-fit: contain; }
    .header-img-right img { width: 30mm; height: 30mm; object-fit: contain; }
    .footer-img-left  img,
    .footer-img-right img { width: 35mm; height: 35mm; object-fit: contain; }
    ...
    .tab   { display: block; text-indent: 40px; }
    .tab-2 { display: block; text-indent: 80px; }

    .no-space     { line-height: 1    !important; margin: 0 !important; }
    .single-space { line-height: 1    !important; margin: 0 0 0.5em 0 !important; }
    .space-115    { line-height: 1.15 !important; margin: 0 0 0.5em 0 !important; }

    .pt-9  { font-size: 9pt  !important; }
    .pt-10 { font-size: 10pt !important; }
    .pt-11 { font-size: 11pt !important; }
    .pt-15 { font-size: 15pt !important; }
    ...
    <tr>
      <td class="font-arial">
        ...
        <div class="row keep-together">
          ...
          <div class="col-5">
            <?php foreach ($travel_order['persons'] as $person): ?>
              <p class="space-115 pt-9"><strong><?= esc(strtoupper($person['name'])) ?></strong></p>
            <?php endforeach; ?>
          </div>
        ...
        <div class="row keep-together">
          ...
          <div class="col-5">
            <?php foreach ($travel_order['persons'] as $person): ?>
              <p class="space-115 pt-9"><strong><?= esc($person['position']) ?></strong></p>
            <?php endforeach; ?>
          </div>
          <div class="col-2 d-flex justify-content-between mb-0">
        ...
        <div class="row keep-together">
          ...
          <div class="col-9">
            <p class="space-115 pt-9"><?= esc(date('F j, Y', strtotime($travel_order['departure_date']))) ?></p>
          </div>
        </div>
        <br />
        ...
        <div class="row keep-together">
          ...
          <div class="col-9">
            <p class="space-115 pt-9"><?= esc(date('F j, Y', strtotime($travel_order['arrival_date']))) ?></p>
          </div>
        </div>
        <br />
